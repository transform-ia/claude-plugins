...
# bootstrap.sh - Create CI workflow and dependabot for new repository
#
# Usage: bootstrap.sh <directory> [--go] [--docker] [--helm]
...
if [[ $# -lt 1 ]]; then
    echo "Usage: bootstrap.sh <directory> [--go] [--docker] [--helm]"
    exit 1
fi
