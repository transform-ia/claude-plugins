---
description: "Check workflow status: /github:workflow-status [owner/repo] [limit]"
allowed-tools: [Bash(${CLAUDE_PLUGIN_ROOT}/scripts/workflow-status.sh *)]
---
...
detect repository. Usage: /github:workflow-status [owner/repo] [limit]"
...
```text
Bash("${CLAUDE_PLUGIN_ROOT}/scripts/workflow-status.sh $ARGUMENTS")
```
