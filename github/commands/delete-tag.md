---
description:
  "Delete tag and artifacts: /github:delete-tag <tag> [directory]"
allowed-tools: [Bash(${CLAUDE_PLUGIN_ROOT}/scripts/delete-tag.sh *)]
---
...
**Usage**: `/github:delete-tag <tag> [directory]`

**Examples**:

```text
/github:delete-tag v1.0.0                    # Delete v1.0.0 in current directory
/github:delete-tag 1.0.0                     # Delete v1.0.0 (auto-adds 'v' prefix)
/github:delete-tag v1.0.0 /path/to/repo      # Delete tag in specific directory
```
...
```text
Bash("${CLAUDE_PLUGIN_ROOT}/scripts/delete-tag.sh $ARGUMENTS")
```
