---
description: "Push and wait for builds: /github:push-and-wait [owner/repo]"
allowed-tools: [Bash(${CLAUDE_PLUGIN_ROOT}/scripts/push-and-wait.sh *)]
---
...
**Usage**: `/github:push-and-wait [owner/repo]`

**Examples**:

```text
/github:push-and-wait transform-ia/claude-image
/github:push-and-wait  # Auto-detect from git remote
```
...
```text
Bash("${CLAUDE_PLUGIN_ROOT}/scripts/push-and-wait.sh $ARGUMENTS")
```
