...
allowed-tools: [Bash(${CLAUDE_PLUGIN_ROOT}/scripts/release.sh *), SlashCommand(/github:push-and-wait)]
---
...
with: "Error: version required. Usage: /github:release `<version>`" and STOP.
...
**Usage**: `/github:release [directory] <version>`

**Examples**:

```text
/github:release 1.2.0                                    # Explicit version in current dir
/github:release patch                                    # Auto-bump patch version
/github:release minor                                    # Auto-bump minor version
/github:release major                                    # Auto-bump major version
/github:release auto                                     # Auto-detect from files or commits
/github:release /path/to/project patch                   # Release project in specific directory
/github:release ~/my-app auto                            # Auto-detect version for specific project
```
...
**Automatically calls `/github:push-and-wait` to wait for all workflows to
complete.**

1. **Build monitoring** (via `/github:push-and-wait`):
...
- **Helm chart updates**: Use `/helm:release` in chart repository
...
- Calls `/github:push-and-wait` for build monitoring
