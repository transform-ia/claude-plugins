---
description: "Lint .github files: /github:actionlint [directory]"
allowed-tools: [Bash(${CLAUDE_PLUGIN_ROOT}/scripts/actionlint.sh *)]
---
...
Usage: /github:actionlint [directory]"
...
```text
Bash("${CLAUDE_PLUGIN_ROOT}/scripts/actionlint.sh $ARGUMENTS")
```
