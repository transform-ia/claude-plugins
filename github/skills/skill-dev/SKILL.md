...
allowed-tools: Read, Write(.github/*), Edit(.github/*), Glob, Grep, Bash(rm .github/**/*.yaml, rm .github/**/*.yml, rm .github/**/*.md), Bash(gh * list *), Bash(gh * view *), Bash(gh * watch *), Bash(gh * status *), Bash(gh * diff *), Bash(gh api *), Bash(git *), Bash(tree *), Task, TodoWrite, SlashCommand(/github:*), SlashCommand(/orchestrator:cmd-detect *), mcp__github__*, AskUserQuestion
---
