...
```bash
/docker:image-tag ghcr.io/transform-ia/golang-image
/docker:image-tag ghcr.io/transform-ia/claude-image
```
...
Use `/github:release <version>` after updating workflows or for any changes
