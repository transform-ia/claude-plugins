...
description: |
  ...
  **Slash Commands** (`/graphql:cmd-*`): Single-operation wrappers for specific tasks:
  - `/graphql:cmd-validate` - Validate GraphQL documents
  - `/graphql:cmd-codegen` - Run GraphQL codegen

  **Skills** (`graphql:skill-dev`): Extended context for complex workflows involving:
