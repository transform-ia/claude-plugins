...
| $30–$149.99 | Simplified receipt | Supplier name, date, total, GST/QST indication ("taxes included"); registration number NOT required |
| $150 and over | Full invoice | Supplier name/address, date, description, total before tax, GST + CRA BN/RT, QST + RQ registration/TQ |
