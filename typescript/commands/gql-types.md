---
description: "Run GraphQL Codegen: /typescript:gql-types <directory>"
allowed-tools: [Bash(${CLAUDE_PLUGIN_ROOT}/scripts/gql-types.sh *)]
---
...
required. Usage: /typescript:gql-types DIRECTORY" and STOP. Do not proceed
with any tool calls.
...
```text
Bash("${CLAUDE_PLUGIN_ROOT}/scripts/gql-types.sh $ARGUMENTS")
```
