---
description: "Run ESLint: /typescript:eslint <directory>"
allowed-tools: [Bash(${CLAUDE_PLUGIN_ROOT}/scripts/eslint.sh *)]
---
...
required. Usage: /typescript:eslint DIRECTORY" and STOP. Do not proceed with
any tool calls.
...
```text
Bash("${CLAUDE_PLUGIN_ROOT}/scripts/eslint.sh $ARGUMENTS")
```
